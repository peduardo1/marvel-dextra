...
VALUES  ('Homem Aranha - numero 154', null, CURRENT_DATE, 'Capa dura', 64),
        ('Powers of X', NULL, CURRENT_DATE, 'Brochura', 32),
        ('Hulk', NULL, CURRENT_DATE, 'Revista', 64),
        ('X-men', NULL, CURRENT_DATE, 'Almanaque', 128),
        ('Homem Aranha - numero 154', NULL, CURRENT_DATE, 'Capa dura', 64),
...
VALUES ('Homem Aranha - numero 154', NULL, CURRENT_DATE, TO_DATE('1991-04-22 00:00:00', 'YYYY-MM-DD HH:MM:SS'),
        TO_DATE('1991-04-22 00:00:00 00:00:00', 'YYYY-MM-DD HH:MM:SS')),
 ('Homem Aranha - numero 154', NULL, CURRENT_DATE, TO_DATE('1991-04-22 00:00:00', 'YYYY-MM-DD HH:MM:SS'),
...
VALUES ('Homem Aranha - numero 154', NULL, CURRENT_DATE, 1991, 1993),
 ('Powers of X', NULL, CURRENT_DATE, 1991, 1993),
 ('Hulk', NULL, CURRENT_DATE,  1991, 1993),
 ('X-men', NULL, CURRENT_DATE,  1991, 1993),
 ('Homem Aranha - numero 154', NULL, CURRENT_DATE, 1991, 1993),
...
VALUES ('Homem Aranha - numero 154', NULL, CURRENT_DATE, '1991'),
 ('Powers of X', NULL, CURRENT_DATE, '1991'),
 ('Hulk', NULL, CURRENT_DATE,  '1991'),
 ('X-men', NULL, CURRENT_DATE,  '1991'),
 ('Homem Aranha - numero 154', NULL, CURRENT_DATE, '1991'),
